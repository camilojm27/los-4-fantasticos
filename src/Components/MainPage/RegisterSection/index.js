                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <RegisterForm>
                            ...
                            <RegisterGridInput>
                                ...
                                <ErrorMesage> {errors.password_repeat.message} </ErrorMesage>}
                            </RegisterGridInput>
                                    ...
                                    <PlacesAutocomplete value={address} onChange={setAddress} onSelect={handleSelect}>
                                        ...
                                        {({getInputProps, suggestions, getSuggestionItemProps, loading}) => (
                                            ...
                                            <div>
                                                ...
                                                <I> <IconMap/> </I>
                                                <InputBlock {...getInputProps({placeholder: "Direccion de residencia"})}
                            ...
                            <RegisterGridInput>
                                ...
                                <RegisterInput>
                                    ...
                                    <Input placeholder="Numero de ID" type="text"
                                           name="doc_num" {...register("doc_num", {
                                        required: "Campo obligatorio",
                                        valueAsNumber: {value: true, message: "Debe de ser un numero"}
                                    })} />
                            ...
                            <RegisterGridInput>
                                ...
                                <RegisterInput>
                                    ...
                                    <Input placeholder="Num. celular" type="tel"
                                           name="phone_num" {...register("phone_num", {
                                        required: "Campo obligatorio",
                                        valueAsNumber: {value: true, message: "Debe de ser un numero"}
                                    })} />
                                ...
                                <RegisterInput>
                                    <div>
                                        ...
                                        <Input type="date" placeholder="Año de nacimiento"
                                               name="fecha" {...register("birth", {
                                            required: "Campo obligatorio",
                                            valueAsDate: {value: true, message: "Debe de ser una fecha"}
                                        })} />
